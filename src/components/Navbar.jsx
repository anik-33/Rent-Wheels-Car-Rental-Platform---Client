    ...
    const links = <>
        ...
        {user && (
            <>
                ...
                <NavLink className={({ isActive }) => (isActive ? activeStyle : normalStyle)} to='/mybooking'> <li className=''>My Bookings</li></NavLink>
            </>
        )}
    ...
    return (
        <div className=" navbar bg-base-100  shadow-sm">
                    ...
                    <div className="navbar-start">
                        ...
                        <Link className='flex justify-center items-center text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-red-600' 
                        to='/'> <img className='w-12 h-12 rounded-full' src="https://i.ibb.co.com/w2xxXMQ/Gemini-Generated-Image-ig3uw0ig3uw0ig3u.png" alt="" />Rent Wheel </Link>
                    </div>
